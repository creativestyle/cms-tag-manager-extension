<?php
namespace Creativestyle\CmsTagManagerExtension\Test\Integration\Model;
...
class TagsRepositoryTest extends \PHPUnit\Framework\TestCase
{
    ...
    public function setUp()
    {
        ...
        $this->saveProcessor = $this->objectManager->create(\Creativestyle\CmsTagManagerExtension\Service\Processor\SaveTags::class);
    ...
    protected function itReturnsTag()
    {
        ...
        $this->assertInstanceOf(\Creativestyle\CmsTagManagerExtension\Model\Tags::class, $tag);
