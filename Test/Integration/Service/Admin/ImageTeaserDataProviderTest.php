<?php
namespace Creativestyle\CmsTagManagerExtension\Test\Integration\Service\Admin;
...
class ImageTeaserDataProviderTest extends \PHPUnit\Framework\TestCase
{
    ...
    public function setUp()
    {
        ...
        $this->imageTeaserDataProvider = $this->objectManager->create(\Creativestyle\CmsTagManagerExtension\Service\Admin\ImageTeaserDataProvider::class);
