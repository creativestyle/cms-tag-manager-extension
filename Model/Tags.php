...
class Tags extends \Magento\Catalog\Model\AbstractModel implements \Creativestyle\CmsTagManagerExtension\Api\Data\TagsInterface
{
    ...
    {
        $this->_init('Creativestyle\CmsTagManagerExtension\Model\ResourceModel\Tags');
    }
