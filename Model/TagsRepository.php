...
namespace Creativestyle\CmsTagManagerExtension\Model;

class TagsRepository implements \Creativestyle\CmsTagManagerExtension\Api\TagsRepositoryInterface
{
    ...
    public function __construct(
        \Creativestyle\CmsTagManagerExtension\Model\ResourceModel\Tags\CollectionFactory $collectionFactory,
        \Creativestyle\CmsTagManagerExtension\Model\ResourceModel\Tags $tagsResource,
     ...
     * @return $this
     */
    public function save(\Creativestyle\CmsTagManagerExtension\Api\Data\TagsInterface $tag)
    {
     ...
     * @return $this
     */
    public function delete(\Creativestyle\CmsTagManagerExtension\Api\Data\TagsInterface $tag)
    {
        if($this->getTag($tag->getCmsPageId(), $tag->getTagName())){
